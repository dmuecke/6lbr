...
// foreward sbox
#if AES_SBOX_IN_FLASH
#include <avr/pgmspace.h>
#define SBOX(index)  pgm_read_byte(&sbox[index])


static const unsigned char PROGMEM sbox[256] = {
#else
#define SBOX(index)  sbox[index]
...
// inverse sbox
#if AES_SBOX_IN_FLASH
#define RSBOX(index)  pgm_read_byte(&rsbox[index])


static const unsigned char PROGMEM rsbox[256] = 
#else
#define RSBOX(index)  rsbox[index]
